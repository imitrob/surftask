...
if __name__ == "__main__":
    # load the table /home/behrejan/traj_complete_log/real_exp_half_circle/same_goal_vary_speed/experiments_real_exec_in_sim_v_vs_error.xls
    path_to_experiment_table = os.path.expanduser("~/traj_complete_log/real_exp_half_circle/same_goal_vary_speed/experiments_real_exec_in_sim_v_vs_error.xls")
    ...
    for idx, experiment in experiments.iterrows():
        ...
        path = os.path.expanduser(os.path.join("~", "traj_complete_log", str(experiment["name"]) ,str(experiment["name"]) + "_" + experiment["last_time"] + ".json"))
