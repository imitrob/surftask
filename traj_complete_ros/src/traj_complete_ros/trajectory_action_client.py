...
class TrajectoryActionClient:
    def __init__(self, arm=None, moveGroupCommander=None, topic="/r1/trajectory_controller/follow_joint_trajectory", robotCommander=None):
        ...
        self._state_sub = rospy.Subscriber('/r1/joint_states', JointState, self.robotstate_cb)
